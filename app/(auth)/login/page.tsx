...
import { FiBarChart2, FiLink, FiShield, FiZap, FiCheckCircle } from 'react-icons/fi'
...
export default function LoginPage() {
  ...
  async function handleGoogleLogin() {
    ...
    const { error: authError } = await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: {
        redirectTo: `${process.env.NEXT_PUBLIC_APP_URL || window.location.origin}/api/auth/callback?next=/dashboard`,
      },
    })
    ...
    // If no error, Supabase redirects to Google — no further code runs
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          >
            <div className="mb-7 lg:mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1.5 text-sm sm:text-base">Continue with your Google account</p>
            </div>
